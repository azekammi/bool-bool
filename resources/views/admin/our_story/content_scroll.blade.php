...
<div class="panel panel-flat">
    <div class="panel-heading">
        ...
        <div class="heading-elements">
            <a href="{{route('adminOurStoryImageAdd')}}" class="btn btn-success">Добавить</a>
        </div>
    </div>
    ...
    <table class="table datatable-basic">
        ...
        <tbody>
            @foreach($ourStoryImages as $ourStoryImage)
                <tr>
                    <td>{{$ourStoryImage->id}}</td>
                    <td><img src="{{asset('assets/site/images/'.$ourStoryImage->image_name)}}" style="width:200px;"></td>
