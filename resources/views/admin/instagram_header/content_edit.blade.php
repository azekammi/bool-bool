<div class="panel panel-flat">
    <div class="panel-heading">
        <h6 class="panel-title">Заголовок Инстаграм</h6>
    </div>
                    ...
                    @foreach($languages as $language)
                        <div class="tab-pane {{$language->locale==Lang::getLocale() ? 'active' : ''}}" id="tab_{{$language->id}}">
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" name="heading[{{$language->locale}}]" value="{{ $instagramHeaderTransaltionsLite['heading'][$language->locale] }}" class="form-control">
                                </div>
                            </div>
                        </div>
                    @endforeach
